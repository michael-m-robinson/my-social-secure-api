...
public interface IAuthService
{
    ...
    public Task<ApiResponse<TokenBundleDto>> LoginUserAsync(LoginRequestDto dto);
    public Task<ApiResponse<TokenBundleDto>> LoginUserWith2FaAsync(VerifyTwoFactorDto dto);
